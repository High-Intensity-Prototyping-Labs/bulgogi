...
void domfarolino::printDirectoryStructure(string dir, string prefix, vector<string>& ignore) {
  string filepath;
  DIR *dp;
  struct dirent *dirp;
  ...
  while ((dirp = readdir(dp))) {
    ...
    if (S_ISDIR(filestat.st_mode)) {
            domfarolino::printDirectoryStructure(filepath, prefix + "   │", ignore);
    }
...
vector<string> domfarolino::buildIgnoreVector() {
